...
public class EnhancedVectorContainerWriter extends AbstractFieldWriter implements ComplexWriter {

    private final EnhancedSingleMapWriter mapRoot;
    ...
    private class SpecialMapVector extends MapVector {
        ...
        SpecialMapVector(CallBack callback) {
            super("", null, callback);
        }
